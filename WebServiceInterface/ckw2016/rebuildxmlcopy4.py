    ...
    for childnodes in self.node.childNodes:
      ...
      if childnodes.nodeName !='#text':
        ...
        for childattr in attr:
          ...
          #新xml添加属性信息//！！注意点，节点的属性要用当前的节点来setAttribute
...
# path=r'E:\python-workspace\WebServiceInterface\ckw2016\testxml\ipcx.xml'
# path=r'E:\python-workspace\WebServiceInterface\ckw2016\testxml\syyhcx.xml'
path=r'<?xml version="1.0" encoding="UTF-8"?><USERMARKER><CONDITION><USERNAME>IP000008</USERNAME><PASSWORD>123</PASSWORD></CONDITION></USERMARKER>'
rb=rebuildcode(path,'utf-8')
rexml=rb.rebuild()
# rexml=rb.getpdf()
print(b64(rexml,'utf-8').base64encode())
print(rexml)